...
interface SparksTokenInterface extends ethers.utils.Interface {
    functions: {
        ...
        "getTaxactionWallet()": FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "getTaxactionWallet", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "getTaxactionWallet", data: BytesLike): Result;
...
export class SparksToken extends Contract {
    ...
    interface: SparksTokenInterface;
    ...
    functions: {
        ...
        getTaxactionWallet(overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        getTaxactionWallet(overrides?: CallOverrides): Promise<string>;
    ...
    estimateGas: {
        ...
        getTaxactionWallet(overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        getTaxactionWallet(overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;
