...
interface StakingPoolFactoryInterface extends ethers.utils.Interface {
  functions: {
    ...
    "create(uint256,uint256,uint256,uint256,uint256,uint256,uint256,bool)": FunctionFragment;
  ...
  events: {
    "PoolCreated(address,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,bool)": EventFragment;
...
export class StakingPoolFactory extends Contract {
  ...
  functions: {
    ...
    "create(uint256,uint256,uint256,uint256,uint256,uint256,uint256,bool)"(
      maturityTime: BigNumberish,
      lockTime: BigNumberish,
      sizeAllocation: BigNumberish,
      stakeApr: BigNumberish,
